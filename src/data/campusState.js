...
export const INITIAL_RIDES = [
  {
    ...
    distanceMiles: '1.5 miles',
    estimatedDuration: '7 mins',
    pricePerSeat: 40,
    availableSeats: 3,
    totalSeats: 4,
    carbonOffsetKg: 2.8,
    vehicleType: 'Civic Sedan',
    vehiclePlate: '4KVRIDE',
    isEv: false,
    femaleOnly: false,
    coords: {
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'EV Hybrid',
      mutualCourses: ['ENV 101 Climate Systems']
    },
    ...
    totalSeats: 4,
    carbonOffsetKg: 2.6,
    vehicleType: 'Prius Prime Hybrid',
    vehiclePlate: '6ECO815',
    isEv: true,
    femaleOnly: true,
    coords: {
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'Verified .edu',
      mutualCourses: ['ECON 102 Microeconomics']
    },
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'Safe Commuter',
      mutualCourses: ['CHEM 130 Organic Chemistry']
    },
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'EV Clean Air',
      mutualCourses: ['ECON 210 Econometrics']
    },
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'EV Hybrid',
      mutualCourses: ['ME 220 Robot Kinematics']
    },
    pickup: 'Dormitory North / Off-Campus Quad',
    destination: 'Main Campus Gate',
    departureTime: '8:30 AM',
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'Safe Commuter',
      mutualCourses: ['SOC 101 Intro to Sociology']
    },
    pickup: 'Highland Park Commuter Lot',
    destination: 'Gate 2 - STEM Quad',
    departureTime: '8:45 AM',
  ...
  },
  {
    ...
    driver: {
      ...
      isVerified: true,
      tag: 'EV Hybrid',
      mutualCourses: ['BIOE 201 Cellular Engineering']
    },
    pickup: 'Dormitory North / Off-Campus Quad',
    destination: 'Main Campus Gate',
    departureTime: '9:00 AM',
    ...
    totalSeats: 4,
    carbonOffsetKg: 2.8,
    vehicleType: 'Honda Insight Hybrid',
    vehiclePlate: '5PRY900',
    isEv: true,
    femaleOnly: true,
    coords: {
      pickup: [37.4350, -122.1720],
