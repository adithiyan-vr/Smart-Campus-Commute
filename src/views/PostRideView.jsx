  ...
  return (
    <div className="px-4 py-3 pb-24 max-w-xl mx-auto">
      ...
      <section className="w-full bg-surface-container-lowest rounded-2xl shadow-[0_12px_32px_rgba(11,28,48,0.1)] p-4 sm:p-5 flex flex-col gap-3.5 border border-surface-container-high/70 relative">
        ...
        {/* Eco-Credits Driver Incentive Banner */}
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-3 flex items-start gap-2.5">
          ...
          <div className="text-xs">
            <span className="font-headline font-bold text-emerald-900 block">
              Earn Eco-Credits for Every Student You Drive
            </span>
            <p className="text-[11px] text-emerald-700 leading-relaxed mt-0.5">
              Providing rides to students earns you <strong>+25 to +30 Eco-Credits</strong> per passenger. Redeem your credits as payment for free rides across campus anytime!
            </p>
          </div>
        </div>
