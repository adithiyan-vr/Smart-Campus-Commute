...
export default function ChatView({ activeRide, onBack, currentUser }) {
  ...
  return (
    <div className="px-4 py-3 flex flex-col h-[calc(100vh-140px)] max-w-xl mx-auto pb-20">
      ...
      {/* Input Bar */}
      <form onSubmit={handleSendMessage} className="mt-3 flex items-center gap-2 bg-surface-container-lowest p-2 rounded-2xl border border-surface-container-high shadow-sm">
        <input
          id="chat-input"
          type="text"
          value={inputText}
